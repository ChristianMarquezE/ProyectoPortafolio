...
coleccionesLink.addEventListener('click', function (event) {
  ...
  if (isMobile) {
    ...
    if (!isMenuOpen) {
      ...
      const mainPageUrl = 'http://127.0.0.1:5500/'; // Cambia esto a la URL de tu página principal
      const mainPageUrl1 = 'http://127.0.0.1:5500/index.html';
      const redirectPageUrl = 'http://127.0.0.1:5500/pages/colecciones.html'; // Cambia esto a la URL de la otra página
